...
#         serialized_data = json.dumps(self.serialize(workpiece), indent=4)
#
...
#             "name": workpiece.name,
#             "toolId": workpiece.toolID.name,
#             "glueType": workpiece.glueType.value,
#             "program": workpiece.program.value,
#             "material": workpiece.material,
#             "contour": contour_list,  # Ensure contours are properly serialized as lists
#             "offset": workpiece.offset,
#             "height": workpiece.height,
#             "nozzles": workpiece.nozzles,
#             "sprayPattern": workpiece.sprayPattern,
#             "area": workpiece.contourArea,
#
#         }
#
...
#             for file in files:
#                 if file.endswith(self.WORKPIECE_FILE_SUFFIX):  # Ensure we only process workpiece JSON files
#                     file_path = os.path.join(root, file)
#                     try:
#                         with open(file_path, 'r') as f:
#                             data = json.load(f)  # Load JSON data
#                             print("Data: ", data)
#                             workpiece = self.deserialize(data)  # Deserialize into Workpiece
#                             workpieces.append(workpiece)
#                     except Exception as e:
#                         print(f"Error loading workpiece from {file_path}: {e}")
