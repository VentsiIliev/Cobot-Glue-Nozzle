...
class DXFPathExtractor:
    def __init__(self, filename, wp_layer="External", contour_layer="Contour",fillLayer = "Fill", target_size=(750, 500)):
    ...
    def get_opencv_contours(self):
        ...
        # Convert main workpiece contour (single contour)
