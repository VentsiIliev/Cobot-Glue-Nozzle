...
# def draw_overlay(frame, workpiece, contour):
#     drawWorkpieceId(frame, contour, workpiece.workpieceId)
#     overlay = frame.copy()
#     alpha = 0.8  # Transparency factor
#
...
#
#     details = [
#         f"ID: {workpiece.workpieceId} ",
#         f"Description: {workpiece.description}",
#         f"Program: {workpiece.program}",
#         f"Offset: {workpiece.offset}",
#         f"Height: {workpiece.height} mm",
#         f"Spray Type: {workpiece.sprayType}",
#         f"Glue Type: {workpiece.glueType}",
#         f"Material: {workpiece.material}",
#         f"Nozzles: {workpiece.nozzles}"
#     ]
#
